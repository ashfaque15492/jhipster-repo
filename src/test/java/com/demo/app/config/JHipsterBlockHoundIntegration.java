...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.demo.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.demo.app.security.DomainUserDetailsService", "createSpringSecurityUser");
